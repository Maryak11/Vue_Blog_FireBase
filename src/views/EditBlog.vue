  ...
  <div class="create-post">
    ...
    <div class="container">
      ...
      <div class="blog-actions">
        <button @click="uploadBlog">Update Blog</button>
...
export default {
  ...
  async mounted() {
    ...
    this.$store.commit('setBlogPost', this.currentBlog[0])
  },
  components: {
    BlogCoverPreview,
    Loading
  ...
  computed: {
    ...mapState(['blogPhotoFileURL', 'blogPhotoName', 'profileId']),
    blogTitle: {
      get() {
